<template>
  <div class="bottom-bar">
    <router-link to="/citymap" class="bottom-link" :class="{ active: $route.path.startsWith('/citymap') || $route.path.startsWith('/map') }">
      ...
      <div class="func-panel">
        ...
        <div class="func-scroll">
          <div class="func-grid">
            ...
            <router-link to="/mail" class="func-btn" @click="showMore = false"><span class="func-emoji">📬</span><span class="func-label">邮件</span></router-link>
