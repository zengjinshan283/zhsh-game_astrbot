...
| # | 功能 | 现状 | 目标 | 参考沧澜四海 |
|---|------|------|------|------------|
| 1 | **套装属性UI** | 后端+前端展示已有，缺详情面板 | 套装效果面板 | 破碎の斗魂5件套 |
| 2 | **支线任务内容** | 占位符多 | 填充具体目标/怪物/奖励 | 沧澜四海实测 |
| 3 | **副本次数限制** | 无限刷 | 每日/每周限制+银币重置 | 沧澜四海 |
| 4 | **航海立即完成** | 等待计时 | 消耗道具立即完成 | 沧澜四海 |
...
| 7 | **新手装备设计** | 通用 | 参考沧澜四海8件1级套装 |
| 8 | **竞技场赛季/奖励** | 框架已有 | 赛季+排名奖励 |
