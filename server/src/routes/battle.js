...
router.post('/start-pirate', authMiddleware, async (req, res, next) => {
  try {
    ...
    const battle = {
      ...
      monster_exp: Number(pirate.exp_reward), monster_money_min: Number(pirate.money_reward_min), monster_money_max: Number(pirate.money_reward_max),
...
router.post('/start', authMiddleware, async (req, res, next) => {
  try {
    ...
    const battle = {
      ...
      monster_exp: Number(monster.exp_reward), monster_money_min: Number(monster.money_reward_min), monster_money_max: Number(monster.money_reward_max),
